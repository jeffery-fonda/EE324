...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/d5d3/hdl/verilog" \
       +incdir+"$ref_dir/../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/e0a2/hdl" \
       +incdir+"$ref_dir/../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/5123" \
       +incdir+"../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/d5d3/hdl/verilog" \
       +incdir+"../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/e0a2/hdl" \
       +incdir+"../../../../VGA_Controller.srcs/sources_1/bd/system/ipshared/5123" \
