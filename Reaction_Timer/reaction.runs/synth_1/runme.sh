...
HD_PWD='C:/EE_Classes/EE324_Projects/Reaction_Timer/reaction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reaction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reaction.tcl
