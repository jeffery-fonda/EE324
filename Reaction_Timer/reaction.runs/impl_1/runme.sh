...
HD_PWD='C:/EE_Classes/EE324_Projects/Reaction_Timer/reaction.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reaction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reaction.tcl -notrace
